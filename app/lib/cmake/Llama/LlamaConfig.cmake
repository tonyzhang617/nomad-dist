set(LLAMA_VERSION 0.0.1750)
set(LLAMA_BUILD_COMMIT 6a427f19)
set(LLAMA_BUILD_NUMBER 1750)
...
set(_llama_link_deps "Threads::Threads" "/usr/lib/x86_64-linux-gnu/libopenblas.so")
set(_llama_transient_defines "$<$<CONFIG:Debug>:_GLIBCXX_ASSERTIONS>;GGML_USE_OPENBLAS;_XOPEN_SOURCE=600;_GNU_SOURCE")
